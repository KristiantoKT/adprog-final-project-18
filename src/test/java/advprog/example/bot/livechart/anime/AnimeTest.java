...
public class AnimeTest {
    ...
    void setUp() {
        anime = new Anime("FLCL Progressive",
                "Many years have passed since Naota and Haruhara Haruko shared their adventure together. Meanwhile, the "
                        +"war between the two entities known as Medical Mechanica and Fraternity rages across the galaxy. "
                        +"Enter Hidomi, a young teenaged girl who believes there is nothing amazing to expect from her "
                        +"average life, until one day when a new teacher named Haruko arrives at her school. "
                        +"Soon enough, "
                        +"Medical Mechanica is attacking her town and Hidomi discovers a secret within her that could "
    ...
    @Test
    void getSynopsis() {
        Assertions.assertEquals("Many years have passed since Naota and Haruhara Haruko shared their adventure together."
                +" Meanwhile, the war between the two entities known as Medical Mechanica and Fraternity "
